...
public class WebDriverFactory implements DisposableBean {
  ...
  public WebDriver createWebDriver() throws ClassNotFoundException, NoSuchMethodException,
    ...
    DesiredCapabilities cap = (DesiredCapabilities) DesiredCapabilities.class.getMethod(browserType)
        .invoke(null);
  ...
  public void setCapabilityIfSet(DesiredCapabilities cap, String setting, String value) {
  ...
  private WebDriver createDriver(DesiredCapabilities cap) throws IOException {
    if (sauceLabsTunnel != null) {
      URL remoteUrl = new URL(
          "https://" + sauceUsername + ':' + sauceAccessKey + "@ondemand.saucelabs.com:443/wd/hub");
      ...
      default:
        throw new NotImplementedException("Browser Type: " + browserType);
      }
    }
  }
