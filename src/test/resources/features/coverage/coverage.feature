...
Scenario: Coverage
    ...
    Then the "INSTRUCTION" coverage should be at least 80%
    And the "BRANCH" coverage should be at least 68%
    And the "LINE" coverage should be at least 70%
    And the "COMPLEXITY" coverage should be at least 64%
    And the "METHOD" coverage should be at least 75%
    And the "CLASS" coverage should be at least 76%
