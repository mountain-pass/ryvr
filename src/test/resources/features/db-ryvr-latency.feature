...
Feature: DB Ryvr
  ...
  Scenario: Get Ryvr New Records
    ...
    Then the average write-read latency should be less that 650ms
    And write-read latency for 95% of the records should be less that 1100ms
    And the maximium write-read latency should be less that 1250ms
